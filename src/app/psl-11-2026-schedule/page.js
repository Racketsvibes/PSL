...
const scheduleData = [
  { date: 'Mar 26, 2026', day: 'Thu', match: 1,  teams: 'Lahore Qalandars vs Hyderabad Kingsmen',   venue: 'Lahore',   time: '7:00 PM PKT', status: 'completed', result: 'LQ won by 69 runs' },
  { date: 'Mar 27, 2026', day: 'Fri', match: 2,  teams: 'Quetta Gladiators vs Karachi Kings',        venue: 'Lahore',   time: '7:00 PM PKT', status: 'completed', result: 'QG won by 14 runs' },
  { date: 'Mar 28, 2026', day: 'Sat', match: 3,  teams: 'Peshawar Zalmi vs Rawalpindi Pindiz',       venue: 'Lahore',   time: '2:30 PM PKT', status: 'completed', result: 'PZ won by 22 runs' },
  { date: 'Mar 28, 2026', day: 'Sat', match: 4,  teams: 'Multan Sultans vs Islamabad United',        venue: 'Lahore',   time: '7:00 PM PKT', status: 'completed', result: 'IU won by 5 wkts' },
  { date: 'Mar 29, 2026', day: 'Sun', match: 5,  teams: 'Quetta Gladiators vs Hyderabad Kingsmen',  venue: 'Lahore',   time: '2:30 PM PKT', status: 'today' },
  { date: 'Mar 29, 2026', day: 'Sun', match: 6,  teams: 'Lahore Qalandars vs Karachi Kings',         venue: 'Lahore',   time: '7:00 PM PKT', status: 'today', link: '/lahore-qalandars-vs-karachi-kings' },
  { date: 'Mar 31, 2026', day: 'Tue', match: 7,  teams: 'Islamabad United vs Peshawar Zalmi',       venue: 'Lahore',   time: '7:00 PM PKT', status: 'upcoming' },
  { date: 'Apr 1, 2026',  day: 'Wed', match: 8,  teams: 'Multan Sultans vs Hyderabad Kingsmen',     venue: 'Lahore',   time: '7:00 PM PKT', status: 'upcoming' },
  { date: 'Apr 2, 2026',  day: 'Thu', match: 9,  teams: 'Quetta Gladiators vs Islamabad United',    venue: 'Lahore',   time: '2:30 PM PKT', status: 'upcoming' },
  { date: 'Apr 2, 2026',  day: 'Thu', match: 10, teams: 'Rawalpindi Pindiz vs Karachi Kings',       venue: 'Lahore',   time: '7:00 PM PKT', status: 'upcoming' },
  { date: 'Apr 3, 2026',  day: 'Fri', match: 11, teams: 'Lahore Qalandars vs Multan Sultans',       venue: 'Lahore',   time: '7:00 PM PKT', status: 'upcoming' },
  { date: 'Apr 4, 2026',  day: 'Sat', match: 12, teams: 'Rawalpindi Pindiz vs Islamabad United',    venue: 'Lahore',   time: '7:00 PM PKT', status: 'upcoming' },
  { date: 'Apr 5, 2026',  day: 'Sun', match: 13, teams: 'Quetta Gladiators vs Multan Sultans',      venue: 'Lahore',   time: '7:00 PM PKT', status: 'upcoming' },
  { date: 'Apr 6, 2026',  day: 'Mon', match: 14, teams: 'Multan Sultans vs Rawalpindi Pindiz',      venue: 'Lahore',   time: '7:00 PM PKT', status: 'upcoming' },
  { date: 'Apr 8, 2026',  day: 'Wed', match: 15, teams: 'Hyderabad Kingsmen vs Peshawar Zalmi',     venue: 'Karachi',  time: '7:00 PM PKT', status: 'upcoming' },
  { date: 'Apr 9, 2026',  day: 'Thu', match: 16, teams: 'Lahore Qalandars vs Islamabad United',     venue: 'Karachi',  time: '2:30 PM PKT', status: 'upcoming' },
  { date: 'Apr 9, 2026',  day: 'Thu', match: 17, teams: 'Karachi Kings vs Peshawar Zalmi',          venue: 'Karachi',  time: '7:00 PM PKT', status: 'upcoming' },
  { date: 'Apr 10, 2026', day: 'Fri', match: 18, teams: 'Quetta Gladiators vs Rawalpindi Pindiz',   venue: 'Karachi',  time: '7:00 PM PKT', status: 'upcoming' },
  { date: 'Apr 11, 2026', day: 'Sat', match: 19, teams: 'Peshawar Zalmi vs Lahore Qalandars',       venue: 'Karachi',  time: '2:30 PM PKT', status: 'upcoming' },
  { date: 'Apr 11, 2026', day: 'Sat', match: 20, teams: 'Karachi Kings vs Hyderabad Kingsmen',      venue: 'Karachi',  time: '7:00 PM PKT', status: 'upcoming' },
  { date: 'Apr 12, 2026', day: 'Sun', match: 21, teams: 'Hyderabad Kingsmen vs Islamabad United',   venue: 'Karachi',  time: '7:00 PM PKT', status: 'upcoming' },
  { date: 'Apr 13, 2026', day: 'Mon', match: 22, teams: 'Peshawar Zalmi vs Multan Sultans',         venue: 'Karachi',  time: '7:00 PM PKT', status: 'upcoming' },
  { date: 'Apr 15, 2026', day: 'Wed', match: 23, teams: 'Peshawar Zalmi vs Quetta Gladiators',      venue: 'Karachi',  time: '7:00 PM PKT', status: 'upcoming' },
  { date: 'Apr 16, 2026', day: 'Thu', match: 24, teams: 'Hyderabad Kingsmen vs Rawalpindi Pindiz',  venue: 'Karachi',  time: '2:30 PM PKT', status: 'upcoming' },
  { date: 'Apr 16, 2026', day: 'Thu', match: 25, teams: 'Karachi Kings vs Islamabad United',        venue: 'Karachi',  time: '7:00 PM PKT', status: 'upcoming' },
  { date: 'Apr 17, 2026', day: 'Fri', match: 26, teams: 'Lahore Qalandars vs Quetta Gladiators',    venue: 'Karachi',  time: '7:00 PM PKT', status: 'upcoming' },
